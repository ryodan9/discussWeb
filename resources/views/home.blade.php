            ...
            <div class="container flex justify-content-between">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-0 mx-lg-3">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('home') }}">Discussion</a>
                  </li>
                  <li class="nav-item">
                ...
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                  <li class="nav-item my-auto">
                    <a class="nav-link text-nowrap" href="{{ route('home') }}">Log In</a>
                  </li>
                  <li class="nav-item ps-1 pe-0">
                    <a class="btn btn-primary-white" href="{{ route('home') }}">Sign Up</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section class="container hero">
            <div class="row align-items-center h-100">
              <div class="col-12 col-lg-6">
                <h1>We Run Jakarta<br />Community Forum</h1>
                <p class="mb-4">Empowering the Community to connect, share, and learn</p>
          ...
          <section class="container min-h-372px">
            <div class="row">
              <div class="col-12 col-lg-4 text-center">
                <img class="promote-icon mb-2" src="{{ url('assets/images/discussions.png') }}" alt="Disucussions">
                <h2>Discussion</h2>
                      ...
                      <div class="row">
                        ...
                        <div class="col-5 col-lg-7">
                          <div class="avatar-sm-wrapper d-inline-block">
                            <a class="me-1" href="">
                              <img class="avatar rounded-circle" src="{{ url('assets/images/avatar-sm.png') }}" alt="Avatar">
                            </a>
                          </div>
                          <span class="fs-12px">
                            <a href="" class="me-1 fw-bold">frahman</a>
            ...
            <div class="container">
              <div class="row">
                <div class="col-12 col-lg-6 mb-5 mb-lg-0">
                  <img src="{{ url('assets/images/logo-blue.png') }}" alt="Logo" class="h-32px mb-4">
                  <p class="text-white">Empowering the Community <br />to connect, share, and learn.</p>
                </div>
                  ...
                  <div class="d-flex flex-column flex-lg-row justify-content-end">
                    <div class="d-flex flex-column me-140px mb-3 mb-lg-0">
                      ...
                      <ul class="list-unstyled">
                        <li class="text-white"><a href="mailto:frahmann11@gmail.com">frahmann11@gmail.com</a></li>
                      </ul>
                    </div>
